...
$ = window.$ || {};
$pt = window.$pt || {};
function test(t,e,n,i){
    return $.Encryption.getEncryption(t,e,n,i);
}
$.RSA = $pt.RSA = function() {
    function t(t, e) {
        return new p(t,e)
...
$.Encryption = $pt.Encryption = function() {
    ...
    function getEncryption(t, e, i, n) {
        i = i || "",
        t = t || "";
        for (var o = n ? t : md5(t), r = hexchar2bin(o), p = md5(r + e), a = $pt.RSA.rsa_encrypt(r), s = (a.length / 2).toString(16), l = window.TEA.strToBytes(i.toUpperCase(), !0), c = Number(l.length / 2).toString(16); c.length < 4; )
            c = "0" + c;
        for (; s.length < 4; )
            s = "0" + s;
        window.TEA.initkey(p);
        var u = window.TEA.enAsBase64(s + a + window.TEA.strToBytes(e) + c + l);
        return window.TEA.initkey(""),
